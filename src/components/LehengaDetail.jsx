...
const LehengaDetail = () => {
    ...
    const proDetail = LEHEN.filter(x=>x.id == proid.id)
    ...
    return (
        ...
        <div className="row">
            ...
            <div className="col-md-6 d-flex flex-column justify-content-center">
                ...
                <hr />
                <h1 className="my-4 prices">Rs {product.price} <span className=' discount lead text-danger ms-2'>40%-off</span></h1> 
                ...
                <div className="btn-group my-5 py-2">
                    <button onClick={()=>handleCart(product)} className="btn btn-outline-primary w-50 p-4">ADD TO CART <i className='fa fa-shopping-cart'></i></button>
